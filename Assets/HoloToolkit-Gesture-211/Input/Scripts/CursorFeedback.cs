...
namespace Academy.HoloToolkit.Unity
{
    ...
    ///     Instantiates the HandDetectedFeedback asset.
    ///     Parents the HandDetectedFeedback asset to the cursor billboard object.
    ///     Activates / deactivates the HandDetectedFeedback asset based on the HandDetected state.
    /// </summary>
    public class CursorFeedback : MonoBehaviour
    {
        ...
        private void UpdateScrollDetectedState()
        {
            ...
            // Don't active scrollDetectedGameObject if no cursor, focusedInteractible, or if the navigation gesture recognizer is not actives
            if (CursorManager.Instance == null || FocusedInteractible == null ||
