...
public class AstronautManager : Singleton<AstronautManager>
{
    ...
    void Start()
    {
        ...
        // Add audio keyword and handler to start manipulation gesture recognition.
    ...
    {
        // transition to manipulation gensture recognizer
    ...
    private void ExpandModelCommand(PhraseRecognizedEventArgs args)
    {
        ...
        // Returns all components of Type Animator in the GameObject ExpandedModel or any of its children.
        Animator[] expandedAnimators = ExpandModel.Instance.ExpandedModel.GetComponentsInChildren<Animator>();
